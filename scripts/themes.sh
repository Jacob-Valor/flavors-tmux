...
load_theme() {
    ...
    case "$theme_name" in
        ...
        nord)
            ...
            ;;
        github_dark)
            THEMES[github_background]="#0d1117"
            THEMES[github_foreground]="#c9d1d9"
            THEMES[github_surface]="#161b22"
            THEMES[github_surface_alt]="#0d1117"
            THEMES[github_primary]="#58a6ff"
            THEMES[github_primary_bright]="#79c0ff"
            THEMES[github_success]="#238636"
            THEMES[github_success_bright]="#3fb950"
            THEMES[github_danger]="#da3633"
            THEMES[github_danger_bright]="#f85149"
            THEMES[github_warning]="#d29922"
            THEMES[github_warning_bright]="#e3b341"
            THEMES[github_info]="#58a6ff"
            THEMES[github_info_bright]="#79c0ff"
            THEMES[github_accent]="#a371f7"
            THEMES[github_accent_bright]="#bc8cff"
            THEMES[github_emphasis]="#f0f6fc"
            THEMES[github_muted]="#8b949e"
            THEMES[github_forge_github]="#f0f6fc"
            THEMES[github_forge_gitlab]="#fc6d26"
            ;;
        onedark)
